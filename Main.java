...
public class Main {
    public static void main(String[] args) {
        ...
        SavingsAccount sa = new SavingsAccount(1001, 1000.0, 5.0);
        sa.displayBalance();
        sa.addInterest();
        System.out.println("\nChecking Account");
        CheckingAccount ca = new CheckingAccount(1002, 2000.0, 600.0);
        ca.displayBalance();
        ca.withdraw(2500.0);
        System.out.println("\nFD Account");
        FDAccount fd = new FDAccount(1003, 5000.0, 2, 6.0);
        fd.displayBalance();
